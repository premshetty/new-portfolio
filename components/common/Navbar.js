        ...
        <>
                    ...
                    <div className="flex justify-between items-center border-b-2 border-gray-100 py-2 md:justify-start md:space-x-10">
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                            <a href="#">
                                ...
                                <img
                                    className="h-12 w-auto sm:h-16 p-0"
                                    src="/logo.png"
                                    alt=""
                        ...
                        <div className="-mr-2 -my-2 md:hidden">
                            <button
                                type="button"
                                className="bg-gray-900 rounded-md p-2 inline-flex items-center justify-center text-white hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
                        ...
                        <nav className="hidden md:flex space-x-10">
                            <div className="relative">
                                ...
                                <button
                                    type="button"
                                    className="
                   group bg-gray-900 rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 pb-8'
                  "
            ...
            */}
                                    <svg
                                        className={
                                            flyer === true
                                                ? "transform rotate-180 ml-2 h-5 w-5 text-white group-hover:text-gray-500 transition ease-out duration-200"
                                                : "transform rotate-0 transition ease-out duration-200 ml-2 h-5 w-5 text-white group-hover:text-gray-500"
                                        }
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
          ...
          */}
                            ...
                            <div className="relative">
                                ...
                                <button
                                    type="button"
                                    className="group bg-gray-900 rounded-md text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
